            ...
            children: [
              ...
              Container(
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        Provider.of<Projects>(context, listen: false).projects[widget.pIndex].stairs[widget.sIndex].flights[widget.fIndex].updateFlight(userInputsProvider.textFormFields);
      ...
      child: SizedBox(
        ...
        child: Focus(
          child: TextFormField(
            ...
            onTap: () => controler.selection = TextSelection(
                baseOffset: 0, extentOffset: controler.value.text.length),
          ...
          onFocusChange: (value) {
            if (!value) {
              if (!_error) {
                if (controler.value.text.trim().isNotEmpty ||
                    double.tryParse(controler.value.text) != null) {
                  provider.updateFields(field, controler.text);
...
//
// // import 'package:syncfusion_flutter_datagrid/datagrid.dart';
// import 'package:tomdata/models/flight_map.dart';
//
// import '../models/flight.dart';
//
// class FlightDataCollector extends StatefulWidget {
//   FlightDataCollector({Key? key, required this.template}) : super(key: key);
//   bool load = true;
//   Map template;
//
//   @override
//   State<FlightDataCollector> createState() =>
//       // ignore: no_logic_in_create_state
//   _FlightDataCollectorState();
// }
//
// class _FlightDataCollectorState extends State<FlightDataCollector> {
//   _FlightDataCollectorState();
//
//   late TextEditingController riserController = TextEditingController();
//   late TextEditingController bevelController = TextEditingController();
...
//   //late String? _value;
//
//   double bottomCrotchLength = 30.0;
//   double topCrotchLength = 0.0;
//   //late dynamic flatDistance;
//   //late double postDistance;
//   //late int stairNum;
//   bool showbottomFlatPost = false;
//   bool showRampPost = false;
//   bool showupperFlatPost = false;
//   bool bottomFlatPostEnable = true;
//   bool topFlatPostEnable = true;
//   bool bottomCrotchTextError = false;
//
...
//                                 //currentFocus = upFlatFocus;
//                                 topFlatPostEnable = false;
//                                 return "Please enter valid number";
//                               }
//
//                               if (_upperFlatPost.isNotEmpty) {
//                                 double totDistance = _upperFlatPost.fold(0, (previousValue, element) => previousValue + element.distance);
//                                 if (double.parse(value) <= totDistance) {
//                                   topFlatPostEnable = false;
//                                   return "The Sum of rail-post distance exceeds the available space.";
//                                 }
//                               }
//                               //currentFocus = globalFocus;
//                               topCrotchLength = double.parse(value);
//                               topFlatPostEnable = true;
//                               return null;
//                             },
//                             onTap: () =>
...
//                             controller: topCrotchLengthController,
//                             decoration: InputDecoration(
//                                 labelText: "Distance", errorText: !topFlatPostEnable ? "The Sum of rail-post distance exceeds the available space." : null),
//                             onEditingComplete: () {
//                               if (topFlatPostEnable) {
//                                 setState(() {
//                                   userInputsProvider.updateFields('topCrotchLength', topCrotchLength.toString());
...
//                           ),
//                           onFocusChange: (value) {
//                             bottomCrotchLengthController.selection = TextSelection(baseOffset: 0, extentOffset: bottomCrotchLengthController.value.text.length);
//
//                             if (!value) {
//                               if (topFlatPostEnable) {
//                                 setState(() {
...
//                             controller: bottomCrotchLengthController,
//                             decoration: InputDecoration(
//                                 labelText: "Distance", errorText: !bottomFlatPostEnable ? "The Sum of rail-post distance exceeds the available space." : null),
//                             onEditingComplete: () {
...
//                             height: 10.0,
//                           ),
//                           RampPostTable(postList: _rampPost, resetView: resetView),
//                           const SizedBox(
//                             height: 10.0,
//                           ),
//                           const Divider(
